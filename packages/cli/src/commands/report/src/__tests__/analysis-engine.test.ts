    ...
    test('should group results by matrix parameters correctly', () => {
      const mockRuns: ScenarioRunResult[] = [
        ...
        createMockRunResult({
          ...
          metrics: { execution_time_seconds: 12, llm_calls: 6, total_tokens: 300 },
          evaluations: [
            {
              evaluator_type: 'test_evaluator',
              success: false,
        ...
        createMockRunResult({
          ...
          metrics: { execution_time_seconds: 8, llm_calls: 4, total_tokens: 200 },
          evaluations: [
            {
              evaluator_type: 'test_evaluator',
              success: true,
    ...
    test('should analyze trajectory patterns correctly', () => {
      const mockRuns: ScenarioRunResult[] = [
        ...
        createMockRunResult({
          ...
          metrics: { execution_time_seconds: 12, llm_calls: 8, total_tokens: 400 },
        }),
        createMockRunResult({
          run_id: 'run-3',
          trajectory: [
          ...
          metrics: { execution_time_seconds: 8, llm_calls: 5, total_tokens: 350 },
        }),
      ];
